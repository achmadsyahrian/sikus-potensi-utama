...
const handleRefresh = () => {
    search.value = '';
    router.get(route('academic-periods.index'), {}, { preserveState: true, replace: true });
};
...
const handleSync = () => {
    ...
    router.post(route('academic-periods.sync'), {}, {
        onSuccess: () => {
...
<template>
    ...
    <ConfirmModal
        ...
        message="Apakah Anda yakin ingin melakukan sinkronisasi data periode akademik? Ini akan memperbarui data dari SIAKAD."
