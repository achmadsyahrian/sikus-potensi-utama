...
const handleRefresh = () => {
    search.value = '';
    router.get(route('program-studies.index'), {}, { preserveState: true, replace: true });
};
...
const handleSync = () => {
    ...
    router.post(route('program-studies.sync'), {}, {
        onSuccess: () => {
...
<template>
    ...
    <ConfirmModal
        ...
        message="Apakah Anda yakin ingin melakukan sinkronisasi data program studi? Ini akan memperbarui data dari SIAKAD."
