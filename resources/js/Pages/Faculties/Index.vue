...
import FacultyTableControls from './Partials/FacultyTableControls.vue';
...
const columns = ref([
    ...
    { label: 'Kode Fakultas', key: 'faculty_code', class: '', dataClass: '' },
...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <FacultyTableControls :filters="props.filters" />
